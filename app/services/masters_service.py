...
# Папки услуг Агбиса, за которые мастеру начисляется зарплата. Одна константа
# и для отчёта, и для приложения мастера (сколько заработал на выходе).
SALARY_FOLDER_IDS = frozenset((
    327, 210289, 416, 210282, 216, 210347, 210307, 210320, 210365, 417, 418, 210348,
    210350, 210349, 210405, 326, 328, 210290, 210281, 210268, 210276, 210267, 215, 210275,
    210269, 210278, 108401, 329, 330, 108402, 210270, 210334, 210337, 210341, 210336, 210338,
    210340, 210342, 210343, 210345, 210346, 210291, 210292, 210293, 110409, 210297, 210298, 210299,
    210283, 210308, 110410, 110411, 210309, 210310, 210314, 210315, 210316, 210300, 210306, 210322,
    210323, 210319, 210318, 210317, 210326, 210332, 210333, 210355, 210358, 210363, 210357, 210359,
    210361, 210364, 419, 210280, 210273, 221, 210272, 217, 210277, 210366, 210344, 210356,
    210286, 210274, 210271, 210335, 210353, 210279, 210288, 210380, 210339, 210399, 210360, 210384,
    210296, 210266, 210313, 210331, 210295, 210287, 210294, 210285, 210284, 210325, 210324, 210330,
    210321, 210329, 210328, 210327, 210305, 210312, 210304, 210311, 210303, 210302, 210301, 210351,
    210352, 210382, 210385, 210377, 210391, 210394, 210392, 210378, 210393, 210388, 210396, 210395,
    210381, 210390, 210389, 210397, 210383, 210386, 210379, 210387, 110407, 110421,
))
_SALARY_FOLDERS_SQL = ",".join(str(i) for i in sorted(SALARY_FOLDER_IDS))
