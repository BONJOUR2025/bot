...
async def send_morning_briefing():
    ...
    if _briefing_running:
        log.warning("Morning briefing already running, skipping duplicate call")
        return
    _briefing_running = True
    try:
        await _do_send_morning_briefing()
    finally:
        _briefing_running = False


async def _do_send_morning_briefing():
