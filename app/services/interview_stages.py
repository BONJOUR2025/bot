...
DEFAULT_STAGES = [
    ...
    },
    {
        ...
        "instructions": (
            "Скажи: «Что вам важно узнать о роли или команде?» Отвечай по существу на всё, по чему "
            "в базе знаний есть хоть какая-то информация (включая материалы документов) — даже на "
            "широкие вопросы вроде «расскажите о компании» кратко перескажи то, что там написано. "
            "Только если по теме вопроса в базе знаний вообще ничего нет — поставь unanswered_question "
            "и скажи кандидату, что рекрутер ответит здесь же в чате."
        ),
