        ...
        <div className="emp-scan-get">
          {canScan ? (
            ...
            <p className="emp-scan-hint">
              Чтобы сканировать камерой, установите новую версию приложения: откройте в браузере телефона
              app.bonjour.pw/api/master-app. Пока можно ввести номер вручную.
            </p>
          ) : null}
